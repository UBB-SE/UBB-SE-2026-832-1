...
namespace WinUI.Converters
{
    ...
    public class BoolToVisibilityChatConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            if (parameter != null && value != null)
            {
                ...
                {
                    return string.Equals(strVal, ConverterConstants.RoleNutritionist, StringComparison.OrdinalIgnoreCase)
    ...
    public class BoolToFontWeightConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            return value is bool b && b ? ConverterConstants.FontBold : ConverterConstants.FontNormal;
        }
    ...
    {
        public object Convert(object value, Type targetType, object parameter, string language) => value is bool b ? !b : true;

        public object ConvertBack(object value, Type targetType, object parameter, string language) => value is bool b ? !b : true;
    }
    ...
    public class RoleToHorizontalAlignmentConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            return string.Equals(role, ConverterConstants.RoleNutritionist, StringComparison.OrdinalIgnoreCase)
    ...
    public class IntZeroToVisibilityConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            if (int.TryParse(value.ToString(), out int intVal))
            {
                ...
                return (inverse ? !isZero : isZero) ? Visibility.Visible : Visibility.Collapsed;
            }
    ...
    public class RoleToBackgroundConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            var color = string.Equals(role, ConverterConstants.RoleNutritionist, StringComparison.OrdinalIgnoreCase)
                ? ConverterConstants.NutritionistBackground : ConverterConstants.UserBackground;
    ...
    public class UnansweredToHighlightConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            return new SolidColorBrush(shouldHighlight ? ConverterConstants.UnansweredHighlight : ConverterConstants.Transparent);
        }
    ...
    public class IntGreaterThanZeroToVisibilityConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            return (inverse ? !visible : visible) ? Visibility.Visible : Visibility.Collapsed;
        }
